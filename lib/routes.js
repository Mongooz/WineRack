...
Router.map(function(){
	...
	this.route('sharedcellar', {
		template: 'cellar',
		path: '/cellar/:id', data: function() {
			return Cellars.find({user: this.params.id}).fetch();
		}
	});
	this.route('acceptsharedcellar', {
		path: '/accept/:id', data: function() {
